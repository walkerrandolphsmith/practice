    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-20">
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
          I rely on a sponsorship program to crowdsource funding from community
      ...
      <div className="flex flex-wrap justify-center -m-4">
        ...
        <Plan
          name="GOLD"
          description="You want to contribute to our compnay mission and ensure it succeedes."
          price={
            <Fragment>
              {" "}
              <span>$5</span>
...
const Plan = ({ isActive, name, description, price, children }) => (
  <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
    ...
    >
      ...
      {children}
      <SelectPlan isActive={isActive} />
      <p className="text-xs  mt-3">{description}</p>
    </div>
  </div>
);

const SelectPlan = ({ isActive }) => (
  <Link to="/plan" className="mt-auto">
    <button
