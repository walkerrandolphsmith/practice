...
import { ReactComponent as Logo } from "./LogoEdit.svg";
...
export const Hero = ({ setTheme, slim }) => (
  <section id="hero" className="flex flex-col relative w-full p-0 text-white">
    ...
    >
      ...
      ></div>
      <div id="hero-wave" className="absolute bottom-0 left-0 z-50 min-w-full">
        <svg
          viewBox="0 0 1695 57"
    ...
    <div className="absolute mt-4 inset-0 w-100 h-12 z-3">
