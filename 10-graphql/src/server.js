...
const postResolver = {
    Query: {
        ...
        posts: async (parent, { limit, next }, { models }) => cursorPagination(parent, { limit, next }, models.post),
    },
    Mutation: {
        createPost: async (_, { text }, { models }) => {
            ...
            return await models.post.create({ text, userId: "5f24129678f24f0011bb0f96" });
        },
